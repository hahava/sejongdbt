INSERT INTO MOVIE VALUES('M1','광해','이영희',15,'역사','2017-05-11','2017-05-30');
...
INSERT INTO MOVIE_PAYMENT VALUES(default, 'eeww95','M1','P1','2017-05-15');
INSERT INTO MOVIE_PAYMENT VALUES(default, 'ghgh5216','M2','P2','2017-05-15');
INSERT INTO MOVIE_PAYMENT VALUES(default, 'kmono','M3','P1','2017-05-15');
INSERT INTO MOVIE_PAYMENT VALUES(default, 'minhokim','M4','P1','2017-05-15');
INSERT INTO MOVIE_PAYMENT VALUES(default, 'taobaoluv','M5','P1','2017-05-15');
INSERT INTO MOVIE_PAYMENT VALUES(default, 'miomio12','M6','P1','2017-05-15');
INSERT INTO MOVIE_PAYMENT VALUES(default, 'ghgh5216','M7','P1','2017-05-15');
INSERT INTO MOVIE_PAYMENT VALUES(default, 'eeww95','M8','P1','2017-05-15');
INSERT INTO MOVIE_PAYMENT VALUES(default, 'eeww95','M9','P1','2017-05-15');
INSERT INTO MOVIE_PAYMENT VALUES(default, 'eeww95','M10','P1','2017-05-15');
INSERT INTO MOVIE_PAYMENT VALUES(default, 'bighead','M11','P11','2017-05-17');
INSERT INTO MOVIE_PAYMENT VALUES(default, 'prettyyeye','M12','P12','2017-05-16');
...
INSERT INTO MYUSER_SNACK_ORDER VALUES(default,'ghgh5216','S1','2017-05-09');
INSERT INTO MYUSER_SNACK_ORDER VALUES(default,'hahava','S2','2017-05-10');
INSERT INTO MYUSER_SNACK_ORDER VALUES(default,'jayjay','S2','2017-05-10');
INSERT INTO MYUSER_SNACK_ORDER VALUES(default,'miomio12','S3','2017-05-10');
INSERT INTO MYUSER_SNACK_ORDER VALUES(default,'prettyyeye','S4','2017-05-11');
INSERT INTO MYUSER_SNACK_ORDER VALUES(default,'bighead','S5','2017-05-11');
INSERT INTO MYUSER_SNACK_ORDER VALUES(default,'minhokim','S6','2017-05-12');
INSERT INTO MYUSER_SNACK_ORDER VALUES(default,'eeww95','S7','2017-05-13');
INSERT INTO MYUSER_SNACK_ORDER VALUES(default,'ghc22','S8','2017-05-13');
INSERT INTO MYUSER_SNACK_ORDER VALUES(default,'taobaoluv','S8','2017-05-14');
INSERT INTO MYUSER_SNACK_ORDER VALUES(default,'ghc22','S9','2017-05-14');
INSERT INTO MYUSER_SNACK_ORDER VALUES(default,'ghgh5216','S10','2017-05-17');
...
INSERT INTO EMPLOYEE VALUES(default,'황알찬',50,'남','사장','2000-01-01',default);
INSERT INTO EMPLOYEE VALUES(default,'이민혁',32,'남','재무관리','2010-01-01',default);
INSERT INTO EMPLOYEE VALUES(default,'지현우',25,'남','비품담당','2008-01-01',default);
INSERT INTO EMPLOYEE VALUES(default,'최진리',37,'남','청소용역','2015-04-01',default);
INSERT INTO EMPLOYEE VALUES(default,'전소미',22,'여','IT팀','2011-01-01',default);
INSERT INTO EMPLOYEE VALUES(default,'박경리',28,'여','매니저','2012-01-01',default);
INSERT INTO EMPLOYEE VALUES(default,'문현아',31,'여','인사담당','2013-01-01',default);
INSERT INTO EMPLOYEE VALUES(default,'최수영',32,'여','홍보담당','2010-01-01',default);
INSERT INTO EMPLOYEE VALUES(default,'이순규',28,'여','배급담당','2016-01-01',default);
INSERT INTO EMPLOYEE VALUES(default,'황미영',27,'여','일반직원','2017-01-01',default);
INSERT INTO EMPLOYEE VALUES(default,'권혜원',27,'여','법무팀','2016-03-01',default);
INSERT INTO EMPLOYEE VALUES(default,'김수현',28,'남','경호팀','2010-04-01',default);
...
INSERT INTO MOVIE_AD VALUES(default, 'M1','강한남자, 헛개차');
INSERT INTO MOVIE_AD VALUES(default,'M1','새로운 터치감 ! 마제스터치 키보드');
INSERT INTO MOVIE_AD VALUES(default,'M1','탈모엔? 마이녹실!');
INSERT INTO MOVIE_AD VALUES(default,'M1','행복한 척추');
INSERT INTO MOVIE_AD VALUES(default,'M2','행복한 척추');
INSERT INTO MOVIE_AD VALUES(default,'M2','숙취엔 여명 808');
INSERT INTO MOVIE_AD VALUES(default,'M2','KT - 아빠와 특별한 추억을');
INSERT INTO MOVIE_AD VALUES(default,'M2','앞뒤가 똑같은 대리운전');
INSERT INTO MOVIE_AD VALUES(default,'M3','AWS - 새로운 클라우드의 혁신을 맛보세요');
INSERT INTO MOVIE_AD VALUES(default,'M4','AWS - 새로운 클라우드의 혁신을 맛보세요');
INSERT INTO MOVIE_AD VALUES(default,'M5','탈모엔? 마이녹실!');
INSERT INTO MOVIE_AD VALUES(default,'M6','페레로 로쉐');
INSERT INTO MOVIE_AD VALUES(default,'M7','탈모엔? 마이녹실!');
INSERT INTO MOVIE_AD VALUES(default,'M8','새로운 터치감 ! 마제스터치 키보드');
INSERT INTO MOVIE_AD VALUES(default,'M9','CHANEL NO.5 PERFUME');
INSERT INTO MOVIE_AD VALUES(default,'M10','새로운 터치감 ! 마제스터치 키보드');
