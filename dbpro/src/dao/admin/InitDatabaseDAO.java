...
public class InitDatabaseDAO implements DAO {
	...
	public void list() {
		...
		String temp="INSERT INTO MOVIE VALUES('M1','광해','이영희',15,'역사','2017-05-11','2017-05-30');" + 
				...
				"INSERT INTO PAYMENT VALUES('P1','체크카드');" + 
				"INSERT INTO PAYMENT VALUES('P2','무통장입금');" + 
				"INSERT INTO PAYMENT VALUES('P3','신용카드');" + 
				"INSERT INTO PAYMENT VALUES('P4','문화상품권');" + 
				"INSERT INTO PAYMENT VALUES('P5','해피포인트');" + 
				"INSERT INTO PAYMENT VALUES('P6','백화점상품권');" + 
				"INSERT INTO PAYMENT VALUES('P7','나라사랑');" + 
				"INSERT INTO PAYMENT VALUES('P8','현금결제');" + 
				"INSERT INTO PAYMENT VALUES('P9','YES24 포인트');" + 
				"INSERT INTO PAYMENT VALUES('P10','전체통장입금');" + 
				"INSERT INTO PAYMENT VALUES('P11','PAYCO');" + 
				"INSERT INTO PAYMENT VALUES('P12','핸드폰결제');" + 
				...
				"INSERT INTO EMPLOYEE VALUES(EMPLOYEE_INC.NEXTVAL,'최진리',37,'남','청소용역','2015-04-01',default);" + 
				"INSERT INTO EMPLOYEE VALUES(EMPLOYEE_INC.NEXTVAL,'전소미',22,'여','IT팀','2011-01-01',default);" + 
				"INSERT INTO EMPLOYEE VALUES(EMPLOYEE_INC.NEXTVAL,'박경리',28,'여','매니저','2012-01-01',default);" + 
				...
				"INSERT INTO EMPLOYEE VALUES(EMPLOYEE_INC.NEXTVAL,'이순규',28,'여','배급담당','2016-01-01',default);" + 
				"INSERT INTO EMPLOYEE VALUES(EMPLOYEE_INC.NEXTVAL,'황미영',27,'여','일반직원','2017-01-01',default);" + 
				"INSERT INTO EMPLOYEE VALUES(EMPLOYEE_INC.NEXTVAL,'권혜원',27,'여','법무팀','2016-03-01',default);" + 
				"INSERT INTO EMPLOYEE VALUES(EMPLOYEE_INC.NEXTVAL,'김수현',28,'남','경호팀','2010-04-01',default);" + 
				...
				"INSERT INTO MOVIE_ACTOR VALUES('A1','M1','주연');" + 
				"INSERT INTO MOVIE_ACTOR VALUES('A2','M1','조연');" + 
				"INSERT INTO MOVIE_ACTOR VALUES('A3','M2','주연');" + 
				"INSERT INTO MOVIE_ACTOR VALUES('A4','M2','조연');" + 
				"INSERT INTO MOVIE_ACTOR VALUES('A5','M3','주연');" + 
				"INSERT INTO MOVIE_ACTOR VALUES('A6','M3','조연');" + 
				"INSERT INTO MOVIE_ACTOR VALUES('A7','M4','주연');" + 
				"INSERT INTO MOVIE_ACTOR VALUES('A8','M4','조연');" + 
				"INSERT INTO MOVIE_ACTOR VALUES('A9','M5','주연');" + 
				"INSERT INTO MOVIE_ACTOR VALUES('A10','M5','조연');" + 
